 ...
 *
 * 源码在这里
 * https://github.com/JingMeng/constraintlayout/blob/cba6f71150397b605947b878258112003880a44f/constraintlayout/constraintlayout/src/main/java/androidx/constraintlayout/motion/widget/KeyPosition.java
 *
 * 这个项目，主要去看事件分发的操作
 * https://github.com/JingMeng/constraintlayout/blob/cba6f71150397b605947b878258112003880a44f/projects/MotionLayoutExperiments/constraintlayout/build.gradle
 *
 */
class MainActivity : AppCompatActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    private val dataset: Array<DemosAdapter.Demo> = arrayOf(
        ...
        DemosAdapter.Demo(
            ...
            "Using MotionLayout and Lottie with ViewPager",
            ViewPagerActivity2::class.java
        ),
        DemosAdapter.Demo(
            "Complex Motion Example (1/4)",
            "Basic CoordinatorLayout-like behavior. Implemented with MotionLayout only, using a moving guideline. Note the view isn't resized. ",
            R.layout.motion_17_coordination
        ),
        DemosAdapter.Demo(
            "Complex Motion Example (2/4)",
            "Advanced CoordinatorLayout-like behavior (adding a FAB). Implemented with MotionLayout only, using a moving guideline. Note the view isn't resized.",
            R.layout.motion_18_coordination
        ),
        DemosAdapter.Demo(
            "Complex Motion Example (3/4)",
            "Advanced CoordinatorLayout-like behavior (adding a FAB). Implemented with MotionLayout only, using direct resizing of the view.",
            R.layout.motion_19_coordination
        ),
        DemosAdapter.Demo(
            "Complex Motion Example (4/4)",
            "Advanced Synchronized reval motion + helper (bounce). Implemented with MotionLayout only.",
            R.layout.motion_20_reveal
        ),
        DemosAdapter.Demo(
            "Fragment Transition Example (1/2)",
            "Example showing transitioning fragments within MotionLayout",
            FragmentExampleActivity::class.java
        ),
        DemosAdapter.Demo(
            "Fragment Transition Example (2/2)",
            "Example showing transitioning fragments within MotionLayout",
            FragmentExample2Activity::class.java
        ),
        DemosAdapter.Demo(
        ...
        DemosAdapter.Demo(
            ...
            "Example that calls a method using KeyTrigger",
         ...
         * https://juejin.cn/post/7028811289602293791
         *
         *MotionLayout 基础教程
         * https://juejin.cn/post/6844903816249212935
         *
         * 官方
         * https://developer.android.com/training/constraint-layout/motionlayout?hl=zh-cn
         *
         ...
         *
         * https://github.com/JingMeng/constraintlayout/blob/56987e7b8709a351ccb4d7a363668a9c58ce9aa3/projects/CarouselExperiments/app/src/main/java/androidx/constraintlayout/experiments/MainActivity.java
         * 这个项目
         */
        DemosAdapter.Demo(
            "Example using Multi State",
            "Example that transitions between multiple states",
            R.layout.motion_26_multistate
        ),
        DemosAdapter.Demo(
            "Histogram Example",
            "Advanced MotionLayout example of creating transition in code and animating dynamic data.",
